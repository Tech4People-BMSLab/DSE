<script lang="ts">  
    ...
    function select(selected: any) {
        ref.answer.selected.value = selected.value
        ref.answer.selected.label = selected.label
        ref.answer.valid          = ref.answer.selected.value !== ''
...
<div class="component" bind:this={element_component} use:onOutsideClick>
    ...
    <div class="fields">
        <div class="field-selected" bind:this={element_anchor} on:click={toggle}>
            <span>{ref.answer.selected.label}</span>
        </div>
